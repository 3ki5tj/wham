...
static wham2_t *wham2_open(const xdouble *bx, const xdouble *by, hist2_t *hist)
{
  wham2_t *w;
...
static void wham2_normalize(xdouble *lnz, int nbeta)
{
  int i;
    ...
    xdouble damp)
{
  ...
  xdouble x, y, bx, by, h, num, lnden, err;
  xdouble dx = hist->dx, dy = hist->dy;
