...
set style line 2  lw 2.0 lt 2 lc rgb color2  pt 8   ps 1.6
set style line 3  lw 2.0 lt 5 lc rgb color3  pt 4   ps 1.2
set style line 4  lw 2.0 lt 4 lc rgb color4  pt 6   ps 1.2

set style line 9  lw 0.5 lt 3 lc rgb color9  pt 1   ps 1.0
...
plot [1.5:3.1][-0.14:0.02] \
  0 w l ls 9 notitle, \
  "../../data/is2/is2nb0.out"   u (1/$2):(-$3+$4) w lp ls 1 notitle, \
  "../../data/is2/is2nb10.out"  u (1/$2):(-$3+$4) w lp ls 2 notitle, \
  "../../data/is2/is2st.out"    u (1/$2):(-$3+$4) w lp ls 3 notitle, \
  "../../data/is2/is2ui.out"    u (1/$2):(-$3+$4) w lp ls 4 notitle, \
...
plot [:-0.7][-0.14:0.1] \
  0 w l ls 9 notitle, \
  "../../data/is2/lndosnb0.dat"   u ($1/n):($2-$3) every 50 w lp ls 1 ps 2.0 notitle, \
  "../../data/is2/lndosnb10.dat"  u ($1/n):($2-$3) every 50 w lp ls 2 ps 2.0 notitle, \
  "../../data/is2/lndosst.dat"    u ($1/n):($2-$3) every 50 w lp ls 3 ps 1.6 notitle, \
  "../../data/is2/lndosui.dat"    u ($1/n):($2-$3) every 50 w lp ls 4 ps 1.6 notitle, \
