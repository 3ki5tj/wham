...
set key at 415, 2e-6 Left reverse font "Times,20" width -7 vertical maxrows 5 spacing 1.0
...
set style line 2  lw 2.0 lt 4 lc rgb color1  pt 4   ps 1.6
...
plot [300:420][3e-10:2e2] \
  ...
  "../../data/1VII/uiwham_de0.1.out"  u (1/BOLTZ/$2):(($1 > 0) ? abs($7-$3) : 1/0) w lp ls 23  t "UIM, {/Times-Italic h} = 0.1", \
