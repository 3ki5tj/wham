...
#set mytics 20
set ylabel "&{i}_{/Symbol*2.0 \341} {/Times-Italic f_i} - {/Times-Italic f_i}^{/*0.7 (ref)}&{i}_{/Symbol*2.0 \361}" offset 1.0, 1.0

set key at 425, -0.15 Left reverse font "Times,16" width -7 vertical maxrows 3 samplen 2.5 spacing 1.0
...
plot [300:420][-0.3:0.3] \
  "../../data/1VII/whamcmpr0.01/xvgerrwham.dat"          u (1/BOLTZ/$2):(($1 > 0) ? ($3 -$5) : 1/0) w lp ls 2   t "WHAM, {/Times-Italic h} = 1", \
  "../../data/1VII/whamcmpr0.01/xvgerrde100wham.dat"     u (1/BOLTZ/$2):(($1 > 0) ? ($3 -$5) : 1/0) w lp ls 3   t "WHAM, {/Times-Italic h} = 100", \
  "../../data/1VII/whamcmpr0.01/xvgerrmbar.dat"          u (1/BOLTZ/$2):(($1 > 0) ? ($3 -$5) : 1/0) w lp ls 4   t "MBAR", \
  "../../data/1VII/whamcmpr0.01/xvgerrstwham.dat"        u (1/BOLTZ/$2):(($1 > 0) ? ($3 -$5) : 1/0) w lp ls 11  t "ST-WHAM, {/Times-Italic h} = 1", \
  "../../data/1VII/whamcmpr0.01/xvgerrde100stwham.dat"   u (1/BOLTZ/$2):(($1 > 0) ? ($3 -$5) : 1/0) w lp ls 12  t "ST-WHAM, {/Times-Italic h} = 100", \
  "../../data/1VII/whamcmpr0.01/xvgerruiwham.dat"        u (1/BOLTZ/$2):(($1 > 0) ? ($3 -$5) : 1/0) w lp ls 13  t "UIM", \
  "../../data/1VII/whamcmpr0.01/xvgerraveambar.dat"      u (1/BOLTZ/$2):(($1 > 0) ? ($3 -$5) : 1/0) w lp ls 21  t "Eq. (10)", \
  "../../data/1VII/whamcmpr0.01/xvgerravebmbar.dat"      u (1/BOLTZ/$2):(($1 > 0) ? ($3 -$5) : 1/0) w lp ls 22  t "Eq. (11)", \
  "../../data/1VII/whamcmpr0.01/xvgerrbarmbar.dat"       u (1/BOLTZ/$2):(($1 > 0) ? ($3 -$5) : 1/0) w lp ls 23  t "BAR, ({/Times-Italic i}, {/Times-Italic i} + 1)"
