...
set key at 410, 1e-6 Left reverse font "Times,16" width -8 vertical maxrows 5 spacing 1.0
...
set style line 3  lw 2.0 lt 4 lc rgb color1  pt 12  ps 2.0
set style line 4  lw 2.0 lt 4 lc rgb color1  pt 4   ps 1.6

set style line 11 lw 2.0 lt 4 lc rgb color2  pt 9   ps 2.0
set style line 12 lw 2.0 lt 4 lc rgb color2  pt 7   ps 1.8
set style line 13 lw 2.0 lt 4 lc rgb color2  pt 13  ps 2.0
set style line 14 lw 2.0 lt 4 lc rgb color2  pt 5   ps 1.6

set style line 9  lw 2.0 lt 1 lc rgb color9  pt 1   ps 1.0

plot [300:420][1e-9:2e2] \
  ...
  "../../data/1VII/stwham_de1000.out" u (1/BOLTZ/$2):(($1 > 0) ? abs($7-$3) : 1/0) w lp ls 14  t "ST-WHAM, {/Symbol D}{/Times-Italic E} = 1000.0", \
  ...
  "../../data/1VII/wham_de1000.out"   u (1/BOLTZ/$2):(($1 > 0) ? abs($7-$3) : 1/0) w lp ls 4   t "WHAM, {/Symbol D}{/Times-Italic E} = 1000.0", \
