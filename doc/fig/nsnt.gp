...
plot [0:20][] \
  ...
  "../../data/1VII/xvgtmmbar.dat"     u 1:(($1 > -1 && $1 <= 12) ? ($2/vlmscl) : 1/0) axes x1y2 w lp ls 13 t "Villin, {/Times-Italic NVT}, MBAR, {/Times-Italic t}_{/=16 rel}", \
  "../../data/1VII/xvgtmwham.dat"     u 1:(($1 > -1 && $1 <= 12) ? ($2/vlwscl) : 1/0) axes x1y2 w lp ls 12 t "Villin, {/Times-Italic NVT}, WHAM, {/Times-Italic t}_{/=16 rel}", \
  ...
  "../../data/1VII/xvgmbar.dat"       u 1:(($1 > -1 && $1 <= 12) ? ($2) : 1/0) w lp ls 3 t "Villin, {/Times-Italic NVT}, MBAR, {/Times-Italic N}@_{/=16 iter}   ", \
  "../../data/1VII/xvgwham.dat"       u 1:(($1 > -1 && $1 <= 12) ? ($2) : 1/0) w lp ls 2 t "Villin, {/Times-Italic NVT}, WHAM, {/Times-Italic N}@_{/=16 iter}   ", \
