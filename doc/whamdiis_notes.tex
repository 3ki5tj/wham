...
\exp\left\{
  ...
  +
  \frac{ -(a+a')^2 t^2 + 2 \, (a + a') \, t \, \Delta \beta'}
  { 2 \, a' }
\right\}
d\Delta \beta'
\notag \\
&=
\frac{ 1 } { \sqrt{2 \, \pi \, a \, a' \, (a + 2 a')} }
\int
\exp\left\{
  \frac{
    -(x - a' \Delta \beta)^2
...
\frac{ [(a + a') \, t / \sqrt{2 a'} ]^l }
{ l!}.
\notag
\label{eq:eig_Gaussian_gf}
\end{align}
%
where
$x = (a + a') \, \Delta \beta'$.
