...
%
The energy $E_i$ of each data point $x_i$
...
%
We start by defining an indicator function $\chi_E(x)$,
...
%
In the last step,
we assume that the data points are independent.
%
Since the data points are identical,
we further have
\begin{align*}
G(k)
&=
...
With the definition $n \equiv \langle \chi( E_1 ) \rangle$,
we have
%
\begin{align*}
\log G(k)
