...
{
$\mathrm{var}(n_k \, \Delta E) \approx n_k \, \Delta E$,
}
%
\note{
...
$\mathrm{var}(n_k \, \Delta E / d_k) \approx n_k \, \Delta E/ d_k^2 \propto 1/ d_k$}.
%
...
\begin{center}
  ...
  \caption{
    ...
    %
    \add{Lines are a guide to the eyes.}
  }
\end{center}
\end{figure}
...
reduced the run time significantly\repl{.
...
yields Eq. \eqref{eq:f_MBAR}.\footnote{\add{
