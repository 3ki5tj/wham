...
which involves a \repl{Hessian}{Jacobian} matrix,
...
%
So maybe ``Jacobian'' is a better word?
}
%
...
the \repl{Hessian}{Jacobian} matrix
...
\add{However, methods based on Jacobian matrices
