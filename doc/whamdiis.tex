...
DIIS WHAM and direct WHAM produced the same
dimensionless free energies, which
...
\begin{figure}[h]
  ...
  \caption{
    ...
    %
    The reference values of the free energy and
...
solutions obtained during the iteration.
%
...
%
For simplicity, we shift the origin of energy
to $\bar E$ such that $\bar E = 0$.
%
Thus,
\begin{equation}
\rho_1(E)
...
We expect that
$\Delta f$
decays asymptotically as $\gamma^n$
...
%
This suggests that
if direct WHAM or MBAR
is used on a wide temperature,
hence energy, range,
we expect a very slow convergence.
