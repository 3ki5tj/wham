...
The method was tested on three systems.
%
The tolerance of the error of the free energies is $10^{-10}$.
...
%
Parallel tempering molecular dynamics (MD)
...
The first system is a mini-protein: villin headpiece\cite{duan1998}
(PDB ID: 1VII).
%
