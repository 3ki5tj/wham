...
and it has become
a standard trajectory analysis tool,
...
should match the exact one, $g(E) \, \exp(-\beta_k E)/Z_k$.
%
Since Eq. \eqref{eq:gnk} is exact,
the values from different $k$
...
%
%
%Another way to see Eq. \eqref{eq:gE_WHAM}
...
Numerically,
$f_i$ is often determined by treating Eq. \eqref{eq:f_WHAM}
...
we briefly discuss
two elegant non-iterative alternatives, ST-WHAM\cite{
kim2011}
and UIM\cite{
kastner2005, *kastner2009}.
%
...
\begin{figure}[h]
  ...
  \caption{
    ...
    (2) WHAM on the mini-protein villin headpiece in the $NVT$ ensemble
    (with the bin width of energy histograms being 1.0),
    (3) MBAR on the same protein system,
    and
    (4) WHAM on the LJ fluid in the $NpT$ ensemble.
    %
    ...
    {\color{red} $12.54$, $14.91$, $252.2$, and $1866$} seconds,
    respectively.
    %
...
Dr. Y. Zhao, Dr. M. R. Shirts, J. A. Drake and Dr. G. C. Lynch
...
&=
-\log \int
\frac{ [\rho_1(E) + \rho_2(E)] \, \exp(-\Delta \beta \, E) }
