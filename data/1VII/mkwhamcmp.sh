...
$prog   --wham=mdiis --tol=1e-10 --de=1        -v e.ls > wham_de1.out
$prog   --wham=st                --de=1     -H -v e.ls > stwham_de1.out
$prog   --wham=mdiis --tol=1e-10 --de=10       -v e.ls > wham_de10.out
$prog   --wham=st                --de=10    -H -v e.ls > stwham_de10.out
$prog   --wham=mdiis --tol=1e-10 --de=100      -v e.ls > wham_de100.out
$prog   --wham=st                --de=100   -H -v e.ls > stwham_de100.out
$prog   --wham=mdiis --tol=1e-10 --de=1000     -v e.ls > wham_de1000.out
